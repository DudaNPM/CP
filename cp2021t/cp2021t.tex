...
\textbf{Grupo} nr. & 109
\\\hline
a93321 & Duarte Moreira	
\\
a74806 & João Amorim
\\
a93176 & Lucas Carvalho
\end{tabular}
\end{center}
...
&
\ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}\Conid{Op}\times(\Conid{ExpAr}\;\Varid{a})}^2\ensuremath{\mathbin{+}\Conid{Op}\times\Conid{ExpAr}\;\Varid{a}}
}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\textbf{Nota}: De forma a facilitar a visualização do gráfico, assume-se \ensuremath{\Varid{g}\mathrel{=}\Varid{g\char95 eval\char95 exp}}.
...
\ensuremath{\Conid{ExpAr}\;\Varid{a}}
    ...
    \ar@/^1pc/[r]^-{\ensuremath{\Varid{outExpAr}}}
&
\ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}\Conid{Op}\times(\Conid{ExpAr}\;\Varid{a})}^2\ensuremath{\mathbin{+}\Conid{Op}\times\Conid{ExpAr}\;\Varid{a}}
    \ar[d]^{\ensuremath{\Varid{recExpAr}\;(\Varid{cataExpAr}\;\Varid{g})}}
    \ar@/^1pc/[l]^-{\ensuremath{\Varid{inExpAr}}}
\\
\ensuremath{\Varid{a}}
&
\ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}\Conid{Op}\times\Varid{a}}^2\ensuremath{\mathbin{+}\Conid{Op}\times\Varid{a}}
    \ar[l]^-{\ensuremath{\Varid{g}\;\Varid{a}}}
}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\alt{\Varid{g1}\;\Varid{a}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;\Varid{a}\;()\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\mathrel{=}\alt{\Varid{g3}}{\Varid{g4}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;\Varid{b}\mathrel{=}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g4}\mathrel{=}\alt{\Varid{g5}}{\Varid{g6}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g5}\;(\Varid{op},(\Varid{b},\Varid{c}))\mathrel{=}\mathbf{if}\;(\Varid{op}\equiv \Conid{Sum})\;\mathbf{then}\;\Varid{b}\mathbin{+}\Varid{c}\;\mathbf{else}\;\Varid{b}\mathbin{*}\Varid{c}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g6}\;(\Varid{op},\Varid{b})\mathrel{=}\mathbf{if}\;(\Varid{op}\equiv \Conid{Negate})\;\mathbf{then}\mathbin{-}\Varid{b}\;\mathbf{else}\;\Varid{expd}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Aproveitando o facto de \ensuremath{\Conid{X}\mathbin{*}\mathrm{0}\mathrel{=}\mathrm{0}}, para todo e qualquer X, e \ensuremath{\Varid{e}\mathbin{\uparrow}\mathrm{0}\mathrel{=}\mathrm{1}} podemos adicionar estas exceções
ao código realizado no problema anterior da seguinte forma:
...
\\
\ensuremath{\Conid{ExpAr}\;\Varid{a}}
    \ar[d]_-{\ensuremath{\Varid{cataExpAr}\;(\Varid{gopt}\;\Varid{a})}}
    \ar@/^1pc/[r]^-{\ensuremath{\Varid{outExpAr}}}
&
\ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}\Conid{Op}\times(\Conid{ExpAr}\;\Varid{a})}^2\ensuremath{\mathbin{+}\Conid{Op}\times\Conid{ExpAr}\;\Varid{a}}
    \ar@/^1pc/[l]^-{\ensuremath{\Varid{inExpAr}}}
    \ar[d]^{\ensuremath{\Varid{recExpAr}\;(\Varid{cataExpAr}\;\Varid{gopt}\;\Varid{a})}}
\\
\ensuremath{\Varid{a}}
&
\ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}\Conid{Op}\times\Varid{a}}^2\ensuremath{\mathbin{+}\Conid{Op}\times\Varid{a}}
    \ar[l]^-{\ensuremath{\Varid{gopt}\;\Varid{a}}}
}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;(\Conid{Sum})\;(\Varid{a})\;(\Varid{b}))\mathrel{=}i_2\;(i_2\;(i_1\;(\Conid{Sum},(\Varid{a},\Varid{b})))){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;(\Conid{Product})\;(\Varid{a})\;(\Varid{b}))\mathrel{=}\mathbf{if}\;(\Varid{a}\equiv \Conid{N}\;\mathrm{0}\mathrel{\vee}\Varid{b}\equiv \Conid{N}\;\mathrm{0})\;\mathbf{then}\;i_2\;(i_1\;\mathrm{0})\;\mathbf{else}\;i_2\;(i_2\;(i_1\;(\Conid{Product},(\Varid{a},\Varid{b})))){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;(\Conid{Negate})\;\Varid{a})\mathrel{=}i_2\;(i_2\;(i_2\;(\Conid{Negate},\Varid{a}))){}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;(\Conid{E})\;\Varid{a})\mathrel{=}\mathbf{if}\;(\Varid{a}\equiv \Conid{N}\;\mathrm{0})\;\mathbf{then}\;i_2\;(i_1\;\mathrm{1})\;\mathbf{else}\;i_2\;(i_2\;(i_2\;(\Conid{E},\Varid{a}))){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{gopt}\;\Varid{a}\mathrel{=}\alt{\Varid{g1}\;\Varid{a}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}\Conid{Op}\times(\Conid{ExpAr}\;\Varid{a})}^2\ensuremath{\mathbin{+}\Conid{Op}\times\Conid{ExpAr}\;\Varid{a}}
    ...
    \ar@/^1pc/[l]^-{\ensuremath{\Varid{inExpAr}}}
\\
\ensuremath{(\Conid{ExpAr}\;\Varid{a})}^2
&
\ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}\Conid{Op}\times(\Conid{ExpAr}\;\Varid{a})}^2\ensuremath{\times(\Conid{ExpAr}\;\Varid{a})}^2\ensuremath{\mathbin{+}\Conid{Op}\times(\Conid{ExpAr}\;\Varid{a})}^2
...
\\
\>[32]{}\hsindent{7}{}\<[39]%
\>[39]{}((\Conid{BinOp},((\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a}),(\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a})))+{}\<[E]%
\\
\>[39]{}\hsindent{8}{}\<[47]%
\>[47]{}(\Conid{UnOp},(\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a})))){}\<[E]%
\\
\>[B]{}\hsindent{25}{}\<[25]%
\>[25]{}\to (\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;()\mathrel{=}(\Conid{X},\Conid{N}\;\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\mathrel{=}\alt{\Varid{g3}}{\Varid{g4}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;\Varid{a}\mathrel{=}(\Conid{N}\;\Varid{a},\Conid{N}\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g4}\mathrel{=}\alt{\Varid{g5}}{\Varid{g6}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g5}\;(\Conid{Sum},((\Varid{a1},\Varid{a2}),(\Varid{b1},\Varid{b2})))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;\Varid{a1}\;\Varid{b1},\Conid{Bin}\;\Conid{Sum}\;\Varid{a2}\;\Varid{b2}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g5}\;(\Conid{Product},((\Varid{a1},\Varid{a2}),(\Varid{b1},\Varid{b2})))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;\Varid{a1}\;\Varid{b1},\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a1}\;\Varid{b2})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{a2}\;\Varid{b1})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g6}\;(\Conid{Negate},(\Varid{a1},\Varid{a2}))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;\Varid{a1},\Conid{Un}\;\Conid{Negate}\;\Varid{a2}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g6}\;(\Conid{E},(\Varid{a1},\Varid{a2}))\mathrel{=}(\Conid{Un}\;\Conid{E}\;\Varid{a1},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{a1})\;\Varid{a2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;(\Varid{c},\Varid{h},\Varid{s})\mathrel{=}(\Varid{c}\mathbin{*}\mathrm{2}\mathbin{*}\Varid{h}\div \Varid{s},\Varid{h}\mathbin{+}\mathrm{2},\Varid{s}\mathbin{+}\mathrm{1}){}\<[E]%
\\
...
\textbf{NB}: usar divisão inteira. Apresentar de seguida a justificação da solução encontrada.

Assumindo: \ensuremath{\Varid{c}\;\Varid{n}\mathrel{=}{\mathrm{2}\;\Varid{n}!}\div {\Varid{n}\mathbin{+}\mathrm{1}!}\mathbin{*}{\Varid{n}!}} e fazendo uns pequenos cálculos podemos afirmar que,
\begin{eqnarray*}
\start
%
        \ensuremath{\begin{lcbr}\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{1}\\\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{c}\;\Varid{n}\mathbin{*}\mathrm{2}\mathbin{*}(\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1})\div \Varid{n}\mathbin{+}\mathrm{2}\end{lcbr}}
%
\qed
\end{eqnarray*}
Assim, consideremos: \ensuremath{\Varid{h}\;\Varid{n}\mathrel{=}\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{1}} e \ensuremath{\Varid{s}\;\Varid{n}\mathrel{=}\Varid{n}\mathbin{+}\mathrm{2}}
\begin{eqnarray*}
\start
%
        \ensuremath{\begin{lcbr}\Varid{h}\;\mathrm{0}\mathrel{=}\mathrm{1}\\\Varid{h}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{h}\;(\Varid{n})\mathbin{+}\mathrm{2}\end{lcbr}}
%
%
        \ensuremath{\begin{lcbr}\Varid{s}\;\mathrm{0}\mathrel{=}\mathrm{2}\\\Varid{s}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{s}\;(\Varid{n})\mathbin{+}\mathrm{1}\end{lcbr}}
%
\qed
\end{eqnarray*}
Podemos então concluir que: \ensuremath{\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{c}\;\Varid{n}\mathbin{*}\mathrm{2}\mathbin{*}\Varid{h}\;\Varid{n}\div \Varid{s}\;\Varid{n}}

\subsection*{Problema 3}


\textbf{Nota}: Resolução incompleta (é apenas um esboço)
...
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\Varid{h1}\mathrel{=}\underline{\cdot }\comp \Varid{nil}{}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\Varid{h2}\;(\Varid{a},\Varid{g})\mathrel{=}[\mskip1.5mu \Varid{f1},\Varid{f2}\;\Varid{a}\;\Varid{g}\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\Varid{f1}\mathrel{=}\Varid{nil}{}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}(\Varid{f2}\;(\Varid{a},\Varid{g})\;(\Varid{x}\mathbin{:}\Varid{xs}))\;\Varid{z}\mathrel{=}\Varid{concat}\mathbin{\$}(\Varid{sequenceA}\;[\mskip1.5mu \Varid{singl}\comp \Varid{linear1d}\;\Varid{a}\;\Varid{x},\Varid{g}\;\Varid{xs}\mskip1.5mu])\;\Varid{z}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
...
\ColumnHook
\end{hscode}\resethooks
Código auxiliar de forma a ser possível o uso de listas não vazias:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{fL}\;\Varid{f}\mathrel{=}\Varid{id}+\Varid{id}\times\Varid{f}{}\<[E]%
\\
\>[B]{}\Varid{inL}\mathrel{=}\alt{\Varid{singl}}{\Varid{cons}}{}\<[E]%
\\
\>[B]{}\Varid{outL}\;[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathrel{=}i_1\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{outL}\;(\Varid{a}\mathbin{:}\Varid{l})\mathrel{=}i_2\;(\Varid{a},\Varid{l}){}\<[E]%
\\
\>[B]{}\Varid{cataL}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{fL}\;(\Varid{cataL}\;\Varid{g})\comp \Varid{outL}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Gráfico correspondente ao catamorfismo \ensuremath{\Varid{avg}}:
\begin{eqnarray*}
\xymatrix@C=3cm@R=2cm{
\ensuremath{\Conid{A}}^+
...
\ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times\Conid{A}}^+
    \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length }}}
    \ar[l]_-{\ensuremath{\Varid{inL}}}
\\
\ensuremath{\Conid{A}}
&
\ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times\Conid{A}}^2
    \ar[l]^-{\ensuremath{\alt{\Varid{a1}}{\Varid{a2}}}}
}
\end{eqnarray*}
Gráfico correspondente ao catamorfismo \ensuremath{\length }:
\begin{eqnarray*}
\xymatrix@C=3cm@R=2cm{
\ensuremath{\Conid{A}}^+
    \ar[d]_-{\ensuremath{\length }}
&
\ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times\Conid{A}}^+
    \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\conj{\Varid{avg}}{\length }}}
    \ar[l]_-{\ensuremath{\Varid{inL}}}
...
&
\ensuremath{\Conid{A}\mathbin{+}\Conid{A}\times\Conid{A}}^2
    \ar[l]^-{\ensuremath{\alt{\Varid{l1}}{\Varid{l2}}}}
}
\end{eqnarray*}
Assim, após análise do gráfico e usando a lei da recursividade múltipla:
\begin{eqnarray*}
%
...
\end{eqnarray*}
\begin{eqnarray*}
\ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\conj{\alt{\Varid{a1}}{\Varid{a2}}}{\alt{\Varid{l1}}{\Varid{l2}}}}}
\end{eqnarray*}
Usando a lei da troca ficamos com:
\begin{eqnarray*}
\ensuremath{\alt{\conj{\Varid{f}}{\Varid{g}}}{\conj{\Varid{h}}{\Varid{k}}}\mathrel{=}\conj{\alt{\Varid{f}}{\Varid{h}}}{\alt{\Varid{g}}{\Varid{k}}}}
\end{eqnarray*}
\begin{eqnarray*}
\ensuremath{\conj{\Varid{avg}}{\length }\mathrel{=}\cata{\alt{\conj{\Varid{a1}}{\Varid{l1}}}{\conj{\Varid{a2}}{\Varid{l2}}}}}
\end{eqnarray*}
Temos agora condições para calcular \ensuremath{\Varid{avg\char95 aux}\mathrel{=}\conj{\Varid{avg}}{\length }}:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataL}\;\alt{\conj{\Varid{id}}{\Varid{fromIntegral}\comp \Varid{one}}}{\conj{\Varid{divisao}}{\succ \comp \p2\comp \p2}}{}\<[E]%
\\
\>[B]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{divisao}\mathrel{=}\uncurry{(\mathbin{/})}\comp \Varid{adicao}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{adicao}\mathrel{=}\conj{\uncurry{(\mathbin{+})}\comp \Varid{multiplicacao}}{\succ \comp \p2\comp \p2}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{multiplicacao}\mathrel{=}\conj{\p1}{\uncurry{(\mathbin{*})}\comp \p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
A definição \ensuremath{\Varid{pointwise}} do que vemos em cima será:
\begin{eqnarray*}
    \ensuremath{\Varid{a1}\;\Varid{a}\mathrel{=}\Varid{a}}
\end{eqnarray*}
\begin{eqnarray*}
    \ensuremath{\Varid{a2}\;(\Varid{h},(\Varid{m},\Varid{n}))\mathrel{=}(\Varid{h}\mathbin{+}(\Varid{n}\mathbin{*}\Varid{m}))\mathbin{/}(\Varid{n}\mathbin{+}\mathrm{1})}
\end{eqnarray*}
\begin{eqnarray*}
    \ensuremath{\Varid{l1}\;\Varid{a}\mathrel{=}\mathrm{1}}
\end{eqnarray*}
\begin{eqnarray*}
    \ensuremath{\Varid{l2}\;(\Varid{h},(\Varid{m},\Varid{n}))\mathrel{=}\Varid{n}\mathbin{+}\mathrm{1}}
\end{eqnarray*}


Solução para árvores de tipo \LTree:

Seguindo o raciocínio anteriormente aplicado, temos:

Gráfico correspondente ao catamorfismo \ensuremath{\Varid{avgLTree}}:
\begin{eqnarray*}
\xymatrix@C=3cm@R=2cm{
...
\ensuremath{\Conid{A}\mathbin{+}\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A}}
    \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\conj{\Varid{avgLTree}}{\Varid{lengthLTree}}\times\conj{\Varid{avgLTree}}{\Varid{lengthLTree}}}}
    \ar[l]_-{\ensuremath{\Varid{inLTree}}}
\\
\ensuremath{\Conid{A}}
&
\ensuremath{\Conid{A}\mathbin{+}}A^2\ensuremath{\times\Conid{A}}^2
    \ar[l]^-{\ensuremath{\alt{\Varid{a1}}{\Varid{a2}}}}
}
\end{eqnarray*}
Gráfico correspondente ao catamorfismo \ensuremath{\length } para LTrees:
\begin{eqnarray*}
\xymatrix@C=3cm@R=2cm{
\ensuremath{\mathsf{LTree}\;\Conid{A}}
    \ar[d]_-{\ensuremath{\Varid{lengthLTree}}}
&
\ensuremath{\Conid{A}\mathbin{+}\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A}}
    \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\conj{\Varid{avgLTree}}{\Varid{lengthLTree}}\times\conj{\Varid{avgLTree}}{\Varid{lengthLTree}}}}
    \ar[l]_-{\ensuremath{\Varid{inLTree}}}
...
\ensuremath{\Conid{A}}
&
\ensuremath{\Conid{A}\mathbin{+}\Conid{A}}^2\ensuremath{\times\Conid{A}}^2
    \ar[l]^-{\ensuremath{\alt{\Varid{l1}}{\Varid{l2}}}}
}
\end{eqnarray*}
Assim, usando a lei da recursividade múltipla e a lei da troca respetivamente:
\begin{eqnarray*}
\ensuremath{\conj{\Varid{avgLTree}}{\Varid{lengthLTree}}\mathrel{=}\cata{\conj{\alt{\Varid{a1}}{\Varid{a2}}}{\alt{\Varid{l1}}{\Varid{l2}}}}}
\end{eqnarray*}
\begin{eqnarray*}
\ensuremath{\conj{\Varid{avgLTree}}{\Varid{lengthLTree}}\mathrel{=}\cata{\alt{\conj{\Varid{a1}}{\Varid{l1}}}{\alt{\Varid{a2}}{\Varid{l2}}}}}
\end{eqnarray*}
Podemos agora definir \ensuremath{\Varid{gene}}:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{gene}\mathrel{=}\alt{\conj{\Varid{id}}{\Varid{fromIntegral}\comp \Varid{one}}}{\conj{\Varid{a2}}{\Varid{l2}}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{a2}\mathrel{=}\uncurry{(\mathbin{/})}\comp \conj{\Varid{x}}{\Varid{l2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{l2}\mathrel{=}\uncurry{(\mathbin{+})}\comp \conj{\p2\comp \p1}{\p2\comp \p2}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{x}{}\<[6]%
\>[6]{}\mathrel{=}\uncurry{(\mathbin{+})}\comp \conj{\Varid{y}}{\Varid{z}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{y}{}\<[6]%
\>[6]{}\mathrel{=}\uncurry{(\mathbin{*})}\comp \p1{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{z}{}\<[6]%
\>[6]{}\mathrel{=}\uncurry{(\mathbin{*})}\comp \p2{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
A definição \ensuremath{\Varid{pointwise}} do que vemos em cima será:
\begin{eqnarray*}
...
\end{eqnarray*}
\begin{eqnarray*}
    \ensuremath{\Varid{a2}\;((\Varid{m1},\Varid{n1}),(\Varid{m2},\Varid{n2}))\mathrel{=}(\Varid{m1}\mathbin{*}\Varid{n1}\mathbin{+}\Varid{m2}\mathbin{*}\Varid{n2})\mathbin{/}(\Varid{n1}\mathbin{+}\Varid{n2})}
\end{eqnarray*}
\begin{eqnarray*}
    \ensuremath{\Varid{l1}\;\Varid{a}\mathrel{=}\mathrm{1}}
\end{eqnarray*}
\begin{eqnarray*}
    \ensuremath{\Varid{l2}\;((\Varid{m1},\Varid{n1}),(\Varid{m2},\Varid{n2}))\mathrel{=}\Varid{n1}\mathbin{+}\Varid{n2}}
\end{eqnarray*}
